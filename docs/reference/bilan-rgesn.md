...
| 6.1 | Le service évite-t-il le chargement de bibliothèques superflues côté navigateur ? | ✅ | `googleapis` (Sheets/Drive/Slides) n'est importé que dans `app/api/*/route.ts` (exécution serveur, runtime Node) — aucun poids client | — |
